 ...
 *     				--------- 명령문의 집합 : 메소드 ***
 *     				--------- 기능별 처리
 *   데이터 한 개 저장 : 변수 (지역변수 ,전역변수 => 공유변수 , 객체 변수)
 *   				     -----  -------------- 클래스
 *   
 *   데이터를 묶어서 사용 : 같은 데이터형을 묶어서 관리
 *   --------------- 변수명을 통일 (인덱스) => 배열
 *   --------------- 다른 데이터 형을 묶어서 관리 (클래스)
 *   
 *   
...
public class 메소드_1 {
	static void a()
	{
		...
		return; // 생략가능 => 값을 보내줄때 한개만 사용이 가능
	}
	// 시작점 
	public static void main(String[] args) {
